...
# --- Existing CalendarEventInput and create_google_calendar_event function ---
...
@function_tool
def create_google_calendar_event(details: CalendarEventInput) -> str:
    """
...
@function_tool
def list_calendar_events(details: ListEventsInput) -> str:
    """
...
@function_tool
def update_calendar_event(details: UpdateEventInput) -> str:
    """
...
# --- Tool for Cancelling/Deleting Calendar Events ---
...
@function_tool
def cancel_calendar_event(details: CancelEventInput) -> str:
    """
...
create_google_calendar_event.__doc__ = (create_google_calendar_event.__doc__ or "").format(current_date_for_llm_context=_current_date_str)
list_calendar_events.__doc__ = (list_calendar_events.__doc__ or "").format(current_date_for_llm_context=_current_date_str)
update_calendar_event.__doc__ = (update_calendar_event.__doc__ or "").format(current_date_for_llm_context=_current_date_str)
cancel_calendar_event.__doc__ = (cancel_calendar_event.__doc__ or "").format(current_date_for_llm_context=_current_date_str)